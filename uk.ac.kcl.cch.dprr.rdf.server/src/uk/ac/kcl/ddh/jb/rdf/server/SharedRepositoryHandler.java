...
package uk.ac.kcl.ddh.jb.rdf.server;
...
public class SharedRepositoryHandler {
	...
	public static void initInstance(ServletConfig config) throws ServletException{
		...
		instance = new SharedRepositoryHandler(config);
	}
	...
	private SharedRepositoryHandler(ServletConfig config) throws ServletException{
