...
<stylesheet version="1.0"
	...
	<!-- Titles -->
	<variable name="workbench.title">DPRR RDF Repository</variable>
	...
	<variable name="contexts.title">Contexts In DPRR RDF</variable>
	<variable name="types.title">Types In DPRR RDF</variable>
	<variable name="query.title">Query DPRR RDF</variable>
	...
	<!-- Labels -->
	<variable name="workbench.label">DPRR RDF Repository</variable>
	...
	<variable name="copyright.label">
							Data © 2017 King's College London (All rights reserved), 
							RDF Engine © 2015 Eclipse RDF4J Contributors
	</variable>
